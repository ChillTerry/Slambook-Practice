    ...
    for (auto &kp:KeyPoints)
    {
        ...
        for (int i=0; i<8; i++)
        {
            ...
            for (int j=0; j<32; j++)
            {
                ...
                Point2f pp = Point2f(cos_theta * p.x - sin_theta * p.y, 
                                    sin_theta * p.x + cos_theta * p.y) + kp.pt;
                Point2f qq = Point2f(cos_theta * q.x - sin_theta * q.y, 
...
{
    Mat img1 = imread(first_img, 0);
    Mat img2 = imread(second_img, 0);
    ...
    Mat matches_img;
    // namedWindow("matches img", 0);
    // cvResizeWindow("matches img", 800, 600);
    drawMatches(img1, keypoints1, img2, keypoints2, matches, matches_img);
    
    imshow("matches img", matches_img);
    waitKey(0);
} 
